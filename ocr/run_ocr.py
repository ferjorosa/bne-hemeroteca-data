"""
OCR Processing Script using olmOCR
==================================
This script recursively finds and processes PDF files from a specified input directory
using the olmOCR pipeline. It processes all filtered PDFs at once, letting the pipeline
handle the processing. It avoids re-processing files that have already been completed.
